package org.example.ejercicio4.modelo.actividades;
...
public abstract class Actividad implements Serializable {
    ...
    public Inscripcion inscribir(Estudiante estudiante) throws CupoExcedidoException {
        ...
        Inscripcion.ticketDeAcceso ticketDeAcceso = new Inscripcion.ticketDeAcceso(((Integer) inscripciones.size()).toString(),LocalDate.now());
        Inscripcion inscripcion = new Inscripcion(  LocalDate.now(), "inscripto" , estudiante, ticketDeAcceso);
